...
export const EN_DICT: Record<string, string> = {
    ...
    '✓ 已添加到「{v0}」': '✓ Added to “{v0}”',
    '通用': 'General',
    '切换立即生效，保存在本机浏览器，不影响推荐结果的语言。': 'Applies immediately and is stored in this browser. It does not change the language of the recommendations themselves.',
    '曲库 {v0} 首 · 临时候选 {v1} 首': '{v0} in your library · {v1} temporary candidates',
    '临时候选': 'Temporary',
    '全部': 'All',
    '这些是推荐时联网抓来、为了能立刻试听而临时缓存的歌，你没有下载或入库过。MP3 超过缓存期会自动释放，节点保留在这一层。': 'These were fetched from the web during a recommendation so you could play them right away. You never downloaded or imported them. The MP3 is released once the cache expires; the entry stays on this shelf.',
    '清理中...': 'Cleaning up…',
    '清理已过期的临时候选': 'Clear expired candidates',
    '清理失败': 'Cleanup failed',
    '没有可清理的临时候选（还在缓存期内或你操作过的都会保留）': 'Nothing to clear — anything still cached, or that you acted on, is kept',
    '将删除 {v0} 条已过期且从未被你操作过的临时候选，此操作不可撤销。继续？': 'This deletes {v0} expired candidates you never acted on. It cannot be undone. Continue?',
    '✅ 已清理 {v0} 条临时候选': '✅ Cleared {v0} temporary candidates',
    '基于自然语言的音乐推荐': 'Natural-language music recommendations',
    'Enter 发送，Shift + Enter 换行': 'Enter to send, Shift + Enter for a new line',
    '每日推荐': 'Daily picks',
    '网易云日推对账': 'NetEase daily vs your library',
    '网易云': 'NetEase',
    '读取你自己账号的日推列表，并标出每首歌在本地处于哪一层。只读歌名歌手等元数据，不涉及音频文件。': "Reads your own account's daily list and marks which shelf each track is on locally. Metadata only — titles and artists, no audio.",
    '已连接：{v0}': 'Connected as {v0}',
    '（未获取昵称）': '(nickname unavailable)',
    '会话已失效，需要重新扫码': 'Session expired — scan again',
    '未连接网易云账号': 'No NetEase account connected',
    '刷新日推': 'Refresh',
    '断开连接': 'Disconnect',
    '扫码连接': 'Connect by QR',
    '正在生成二维码...': 'Generating QR code…',
    '用网易云音乐 App 扫码': 'Scan with the NetEase Cloud Music app',
    '已扫码，请在手机上确认': 'Scanned — confirm on your phone',
    '二维码已过期，请重新生成': 'QR code expired — generate a new one',
    '无法生成二维码': 'Could not generate a QR code',
    '✅ 网易云账号已连接': '✅ NetEase account connected',
    '断开后将无法读取日推，需要重新扫码。继续？': 'Disconnecting stops daily-list access until you scan again. Continue?',
    '已断开网易云账号': 'NetEase account disconnected',
    '网易云登录二维码': 'NetEase login QR code',
    '登录凭证只保存在后端本机文件里，不会出现在页面、响应体或日志中。': 'The credential is stored in a local backend file only — never in the page, a response body, or a log.',
    '已在曲库': 'In your library',
    '本地没有': 'Not local',
    '共 {v0} 首': '{v0} total',
