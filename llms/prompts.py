...
生成纯英文声学描述供 M2D-CLAP 向量检索（对齐 MusicCaps/AudioCaps 训练风格）：
...
{{"intent_type": "...", "parameters": {{"query": "...", "entities": [...]}}, "context": "一句话描述", "retrieval_plan": {{"use_graph": true/false, "hard_constraints": {{"artist_entities": [], "song_entities": [], "language": null, "region": null, "instrumental": false}}, "soft_intent": {{"goal": "", "trajectory": "", "avoid": [], "vibe": ""}}, "hints": {{"genres": [], "mood": null, "scenario": null}}, "graph_entities": [...], "graph_artist_entities": [...], "graph_song_entities": [...], "graph_genre_filter": null, "graph_scenario_filter": null, "graph_mood_filter": null, "graph_language_filter": null, "graph_region_filter": null, "use_vector": true/false, "vector_acoustic_query": "", "use_web_search": false, "web_search_keywords": ""}}, "reasoning": "..."}}
