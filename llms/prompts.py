...
13. **利用用户长期记忆**：如果上方的 graphzep_facts 中提到了用户喜欢的歌手、流派或风格，请在 parameters 中填入相应的 artist/genre/mood 字段作为检索增强。
14. **排除不喜欢的歌**：如果 graphzep_facts 中提到用户不喜欢某种风格/歌手，在 reasoning 中注明以便后续过滤。
