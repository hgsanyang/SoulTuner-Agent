...
- 兼容要求：hard_constraints 与 hints 填好后，也要同步填 graph_artist_entities、graph_song_entities、graph_language_filter、graph_region_filter、graph_genre_filter、graph_mood_filter、graph_scenario_filter。
