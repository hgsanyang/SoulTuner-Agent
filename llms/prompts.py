...
用户: "周杰伦的情歌"
{{"intent_type": "graph_search", "parameters": {{"query": "周杰伦 情歌", "entities": ["周杰伦", "Jay Chou"]}}, "context": "周杰伦情歌", "retrieval_plan": {{"use_graph": true, "graph_entities": ["周杰伦", "Jay Chou"], "graph_genre_filter": null, "graph_scenario_filter": null, "graph_mood_filter": "浪漫", "graph_language_filter": "Chinese", "graph_region_filter": null, "use_vector": false, "vector_acoustic_query": "", "use_web_search": false, "web_search_keywords": ""}}, "reasoning": "歌手+情绪，图谱匹配"}}

用户: "深夜开长途，高速公路空旷无人"
{{"intent_type": "hybrid_search", "parameters": {{"query": "深夜开车 高速 孤独", "entities": []}}, "context": "深夜独驾孤寂", "retrieval_plan": {{"use_graph": true, "graph_entities": [], "graph_genre_filter": null, "graph_scenario_filter": "开车", "graph_mood_filter": null, "graph_language_filter": null, "graph_region_filter": null, "use_vector": true, "vector_acoustic_query": "A moderate tempo song with ambient synthesizers and soft shimmering guitar over a deep warm bass line. The mood is lonely and contemplative. The sound is spacious and atmospheric.", "use_web_search": false, "web_search_keywords": ""}}, "reasoning": "场景+画面感，图谱粗筛+向量精排"}}

用户: "我心情很差，想哭"
{{"intent_type": "vector_search", "parameters": {{"query": "心情差 悲伤", "entities": []}}, "context": "情绪低落找音乐", "retrieval_plan": {{"use_graph": false, "graph_entities": [], "graph_genre_filter": null, "graph_scenario_filter": null, "graph_mood_filter": null, "graph_language_filter": null, "graph_region_filter": null, "use_vector": true, "vector_acoustic_query": "A slow melancholic song with soft piano and gentle acoustic guitar. The atmosphere is sad and vulnerable, with a quiet sorrowful tone. Minor key, soft dynamics, close and personal feel.", "use_web_search": false, "web_search_keywords": ""}}, "reasoning": "纯情绪无实体，向量捕捉"}}
