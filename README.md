...
```powershell
cd C:\Users\sanyang\sanyangworkspace\music_recommendation\Muisc-Research
...
如果你的机器有 NVIDIA GPU，并且要处理待入库歌曲或提取音频向量，可以改用：
...
| 变量 | 说明 |
| --- | --- |
| `DASHSCOPE_API_KEY` | DashScope / Qwen 模型调用密钥 |
